...
begin
  ...
  UniMainModule.StatsTable.SQL.Text :=
    ...
    'WHERE user_id = :uid AND game_type = ''sudoku'' ' +
  ...
  begin
    UniSession.AddJS('window.isGameCompleted = true;');
    ...
    begin
      ...
      UniSession.AddJS(Format('if(typeof window.showGameOver === "function") window.showGameOver(true, %d, %d, true);', [LMoves, LTimeSec]));
    end
    else
    begin
      UniSession.AddJS('if(typeof window.showGameOver === "function") window.showGameOver(true, 0, 0, false);');
    end;
      ...
      begin
        ...
        begin
          try
            ...
            begin
              UniSession.AddJS('if(typeof window.receiveSudokuData === "function") window.receiveSudokuData(' + JSONRes.ToJSON + ');');
            end
            else
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        if CurrStreak = 30 then
          Shields := 2
        else if CurrStreak = 100 then
          Shields := 3;
      end
      else
      begin
