object QUEENS_FORM: TQUEENS_FORM
  ...
  Script.Strings = (
    ...
    '        window.queensValidationTimer = setTimeout(function() {'
      ...
      '            var mySwal = (typeof Swal !== '#39'undefined'#39') ? Swal : ' +
      '(window.parent && window.parent.Swal ? window.parent.Swal : null' +
      ');'
    '            if (mySwal) {'
    '                mySwal.fire({'
    
      '                    target: window.getVisibleViewport() || docum' +
      'ent.body,'
    
      '                    title: '#39'HATA!'#39', text: '#39'Bu pek dogru gorunmuy' +
      'or...'#39', icon: '#39'warning'#39', toast: true, position: '#39'top'#39', showConfi' +
      'rmButton: false, timer: 2000, background: '#39'#1a1a1b'#39', color: '#39'#ff' +
      'ffff'#39', customClass: { popup: '#39'oct-popup'#39' }'
    '                });'
    '            }'
    '            var boardEl = window.queensEl('#39'#queensBoard'#39');'
    ...
    '};'
    ''
    'window.showQueensGameOver = function(isReplay) {'
    ...
    '    '
      ...
      '    var time = window.queensElapsedTime, moves = window.queensMo' +
      'ves;'
    
      '    var grade = isReplay ? window.queensGrade : window.calculate' +
      'QueensGrade(time);'
    '    '
    '    if (!isReplay) { '
    ...
    '    '
      ...
      '    var m = Math.floor(time / 60).toString().padStart(2, '#39'0'#39'), s' +
      ' = (time % 60).toString().padStart(2, '#39'0'#39'), timeStr = m + '#39':'#39' + ' +
      's;'
    ...
    '    var modalTitle = isReplay ? '#39'G'#220'N'#220'N '#214'ZET'#304#39' : '#39'TEBR'#304'KLER!'#39';'
      ...
      'ze:0.95rem; margin-bottom:20px;">Bu haritay'#305' '#231'oktan fethettin!</' +
      'div>'#39' : '#39#39';'
  ...
  object QueensHTML: TUniHTMLFrame
    ...
    HTML.Strings = (
      ...
      ''
      '    /* ========================================='
      '       TAM EKRAN OYUN KAPSAYICI (Karanl'#305'k Tema)'
      '       ========================================= */'
      '    .queens-viewport {'
      '        position: fixed;'
      ...
      ''
      '    /* ========================================='
      '       OYUN ALANI (Esnek Grid Yap'#305's'#305')'
      '       ========================================= */'
      ...
      '        transition: transform 0.1s, background-color 0.3s;'
        ...
        '        -webkit-tap-highlight-color: transparent; /* Mobilde dok' +
        'unma grili'#287'ini kald'#305'r'#305'r */'
      '    }'
      '    .q-cell:active { transform: scale(0.90); }'
      ''
      '    /* '#304'KON ST'#304'LLER'#304' (Vezir ve '#199'arp'#305') */'
      '    .q-cell.queen {'
      '        color: #f1c40f; '
      ...
      ''
      '    /* ========================================='
      '       B'#214'LGE (REGION) KALIN '#199#304'ZG'#304'LER'#304
      '       ========================================= */'
      ...
      ''
      '    /* ========================================='
      '       PASTEL RENK PALET'#304' (B'#246'lgeler '#304#231'in)'
      '       ========================================= */'
